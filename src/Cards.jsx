                ...
                <div className="card shadow   bg-white rounded" style={style}>
                    <img className="card-img-top image-size-refine" src="about1.png"  alt="Card image cap" style={imgStyle}/>
                        <div className="card-body ">
                            ...
                            <p className="card-text matter">Whether you’re buying your first home or you’ve owned before, let us guide you in navigating this major life decision.</p>
                        </div>
                </div>
            </div>
            <div className=" col-md-4 " >
                <div className="card shadow bg-white rounded " style={style}>
                     <img className="card-img-top image-size-refine" src="about2.png" alt="Card image cap" style={imgStyle} />
                        <div className="card-body">
                            ...
                            <p className="card-text matter pb-4">We’re committed to refinance with lowest rates. Start your application today!</p> 
                        </div>
                </div>
            </div>
            <div className=" col-md-4 " >
